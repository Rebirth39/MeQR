...
class ReviewRegressionTests(unittest.TestCase):
    ...
    def test_card_tags_have_default_and_custom_colors(self):
        ...
        self.assertIn("CardTagColorStyle(segmentHexes: entry.hexes)", cluster)
        ...
        self.assertIn("CardTagInputView(text: $tagInput)", add_profile)
        self.assertIn("CardTagInputView(text: $tagInput)", edit_cluster)
        ...
        self.assertIn("ColorPicker(selection: colorBinding(for: tag), supportsOpacity: false)", editor)
