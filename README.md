...
MeQR 是一款 iOS 应用，帮助你管理和展示多个二维码。你可以将多个二维码归类到一个合集（Cluster）中，每个合集都有独立的名称、头像、背景和样式。无论是社交账号、支付码还是其他二维码，都可以一站式管理。

MeQR is an iOS app that helps you manage and display multiple QR codes. You can group multiple QR codes into a single cluster, each with its own name, avatar, background, and style. Whether it's social media accounts, payment codes, or other QR codes, you can manage them all in one place.
